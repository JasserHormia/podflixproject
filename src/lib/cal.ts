...
export const CAL_SESSIONS = [
  // ⚠️ TEMPORARY — live payment test. REVERT IMMEDIATELY: price: 590
  // calId is deliberately unchanged (6839068, the real event type). Paired
  // with the same override on studio-1h in lib/booking.ts — the two must move
  // together or the customer is shown one price and charged another.
  { id: "rec-1h", name: "1 Hour Recording", category: "studio", hours: 1, price: 5, calId: 6839068 },
